...
###단일연결리스트
<p style="text-align:center;"><img src="/img/3장/단일연결리스트.jpg" width="40%" height="30%" title="단일연결리스트" alt="딘일연결리스트"></img></p>
```{.c}
typedef struct node{
    int elem;
    struct node* link;
...
<br>
<p style="text-align:center;"><img src="/img/3장/헤드노드.jpg" width="40%" height="30%" title="헤드노드" alt="헤드노드"></img></p>
리스트의 전체에서 첫번째 노드를 헤드 노드라고 한다.

###이중연결리스트
<p style="text-align:center;"><img src="/img/3장/이중연결리스트.jpg" width="40%" height="30%" title="이중연결리스트" alt="이중연결리스트"></img></p>
```{.c}
typedef struct node{
    int elem;
    struct node* next;
...
<p style="text-align:center;"><img src="/img/3장/헤드테일.jpg" width="40%" height="30%" title="헤드테일" alt="헤드테일"></img></p>
